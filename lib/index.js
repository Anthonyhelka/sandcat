...
const sandcat = (directory) => {
  ...
  new Promise((resolve, reject) => {
    executeCommand(`mkdir ${directory} && cd ${directory} && git init`, `Create ${directory} directory`)
    .then((result) => {
                  ...
                  new Promise((resolve, reject) => {
                    ...
                    .then((result) => {
                      ...
                      new Promise((resolve, reject) => {
                        ...
                        const newScripts = { "start": "node server.js", "heroku-postbuild": "cd client && yarn install && yarn build", "test": "echo \"Error: no test specified\" && exit 1" };
                        ...
                        .then((result) => {
                          ...
                          new Promise((resolve, reject) => {
                            ...
                            executeCommand(`cd ${directory} && cd client && npm install`, `Update client package.json file`)
                            .then((result) => {
                              console.log(result.bold.green);
